  ...
  return (
    <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
      <GridItem
        ...
        icon={<Wifi className="h-4 w-4 text-black dark:text-neutral-400" />}
      ...
      <GridItem
        ...
        icon={<Waypoints className="h-4 w-4 text-black dark:text-neutral-400" />}
      ...
      <GridItem
        ...
        icon={<Cctv className="h-4 w-4 text-black dark:text-neutral-400" />}
      ...
      <GridItem
        ...
        icon={<Cable className="h-4 w-4 text-black dark:text-neutral-400" />}
