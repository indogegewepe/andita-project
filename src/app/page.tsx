          ...
          >
            {navItems.map((item, idx) => (
              <a
                ...
                className="relative text-white dark:text-blue-900"
              >
...
export function Globe() {
  const globeConfig = {
    ...
    rings: 1,
    maxRings: 3,
    initialPosition: { lat: -7.8078657290200555, lng: 110.39392581294153 },
    autoRotate: true,
    autoRotateSpeed: 0.5,
  };
  const colors = ["#ffffff"];
  ...
  return (
    <div id="home" className="flex flex-row items-center justify-center md:h-auto dark:bg-blue-900 bg-white relative w-full">
